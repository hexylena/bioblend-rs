...
/// HdcJobStateSummary : Overview of the job states working inside a dataset collection.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct HdcJobStateSummary {
