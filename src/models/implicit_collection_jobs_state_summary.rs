...
/// ImplicitCollectionJobsStateSummary : Base model definition with common configuration used by all derived models.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ImplicitCollectionJobsStateSummary {
...
impl ImplicitCollectionJobsStateSummary {
    /// Base model definition with common configuration used by all derived models.
    pub fn new(id: String, populated_state: crate::models::PopulatedStates) -> ImplicitCollectionJobsStateSummary {
