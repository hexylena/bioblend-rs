...
/// HdcaSummary : History Dataset Collection Association summary information.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct HdcaSummary {
...
impl HdcaSummary {
    ...
    pub fn new(collection_id: String, contents_url: String, deleted: bool, hid: i32, history_content_type: crate::models::HistoryContentType, history_id: String, id: String, populated_state: crate::models::PopulatedStates, tags: Vec<String>, url: String, visible: bool) -> HdcaSummary {
        HdcaSummary {
            collection_id,
