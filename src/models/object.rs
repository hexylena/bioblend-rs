...
/// Object : The element's specific data depending on the value of `element_type`.
...
impl Object {
    /// The element's specific data depending on the value of `element_type`.
    pub fn new(history_id: String, id: String, state: crate::models::GalaxyModelDatasetStates, accessible: bool, annotation: String, creating_job: String, data_type: String, dataset_id: String, deleted: bool, display_apps: Vec<crate::models::DisplayApp>, display_types: Vec<crate::models::DisplayApp>, download_url: String, extension: String, file_ext: String, file_size: i32, hid: i32, history_content_type: crate::models::HistoryContentType, meta_files: Vec<crate::models::MetadataFile>, permissions: crate::models::Permissions, purged: bool, rerunnable: bool, resubmitted: bool, tags: Vec<String>, url: String, uuid: String, validated_state: crate::models::ValidatedStates, validated_state_message: String, visible: bool, visualizations: Vec<serde_json::Value>) -> Object {
        Object {
            hda_ldda: None,
            history_id,
            id,
