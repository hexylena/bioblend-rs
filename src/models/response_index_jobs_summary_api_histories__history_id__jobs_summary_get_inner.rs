...
pub struct ResponseIndexJobsSummaryApiHistoriesHistoryIdJobsSummaryGetInner {
...
impl ResponseIndexJobsSummaryApiHistoriesHistoryIdJobsSummaryGetInner {
    pub fn new(id: String, populated_state: crate::models::PopulatedStates) -> ResponseIndexJobsSummaryApiHistoriesHistoryIdJobsSummaryGetInner {
