...
impl ElementsInner1 {
    pub fn new(src: Src, paste_content: String, url: String, path: String, server_dir: String, ftp_path: String, composite: crate::models::CompositeItems, elements: Vec<crate::models::ElementsInner1>) -> ElementsInner1 {
        ElementsInner1 {
            md5: None,
