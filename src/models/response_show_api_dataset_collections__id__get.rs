...
pub struct ResponseShowApiDatasetCollectionsIdGet {
...
impl ResponseShowApiDatasetCollectionsIdGet {
    pub fn new(collection_id: String, contents_url: String, deleted: bool, elements_datatypes: Vec<String>, hid: i32, history_content_type: crate::models::HistoryContentType, history_id: String, id: String, populated: bool, populated_state: crate::models::PopulatedStates, tags: Vec<String>, url: String, visible: bool) -> ResponseShowApiDatasetCollectionsIdGet {
